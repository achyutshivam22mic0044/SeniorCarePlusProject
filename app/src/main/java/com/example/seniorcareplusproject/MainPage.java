...
public class MainPage extends AppCompatActivity {
    ...
    private void sendSOS() {
        if (sosNumber1 != null && sosNumber2 != null && sosNumber3 != null) {
            if (isValidPhoneNumber(sosNumber1) && isValidPhoneNumber(sosNumber2) && isValidPhoneNumber(sosNumber3)) {
                // Get current location
                getCurrentLocation();

                String message = "URGENT SOS MESSAGE!! Patient needs immediate assistance. Current Location: " + currentLocationLink;
                ...
                try {
                    ...
                    sosSent = true;
                    updateDashboardInfo("SOS Sent: " + currentLocationLink);
                ...
                Toast.makeText(this, "Invalid phone numbers!", Toast.LENGTH_SHORT).show();
            }
        } else {
            Toast.makeText(this, "Please set SOS numbers first!", Toast.LENGTH_SHORT).show();
        }
    }
